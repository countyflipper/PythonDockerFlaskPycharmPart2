CREATE DATABASE dbMLB;
use dbMLB;

CREATE TABLE IF NOT EXISTS tblMLB (
    `id` int AUTO_INCREMENT,
    `fldName` VARCHAR(19) CHARACTER SET utf8,
    `fldTeam` VARCHAR(3) CHARACTER SET utf8,
    `fldPosition` VARCHAR(17) CHARACTER SET utf8,
...
INSERT INTO tblMLB  (fldName,fldTeam,fldPosition,fldHeight_inches,fldWeight_lbs,fldAge) VALUES
    ...
    ('Kirk Saarloos','CIN','Starting Pitcher',72,NULL,27.77),
